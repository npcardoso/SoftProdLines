 ...
 * format. The "deflate" format is described in RFC 1951. This stream may form
 * the basis for other decompression filters, such as the
...
public class InflaterInputStream extends InputStream {
	...
	/**
	 * Reads one byte of decompressed data. The byte is in the lower 8 bits of
	 * the int.
	 */
	...
	/**
	 * Calls the <code>read(byte[], int, int)</code> overloaded method. Note
	 * that this method does not redirect its call directly to a corresponding
