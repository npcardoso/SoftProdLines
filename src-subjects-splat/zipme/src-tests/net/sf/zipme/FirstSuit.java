...
public class FirstSuit {
   ...
   *  net.sf.zipme.Deflater.deflate(byte[])
   *   net.sf.zipme.Deflater.deflate(byte[], int, int)      
   *   net.sf.zipme.Deflater.end()  
   *   net.sf.zipme.Deflater.finish()  
   *   net.sf.zipme.Deflater.finished()  
  ...
  public void testDeflation() {
    ...
    Assert.assertNotEquals(d.deflate(b), 0);
    assertEquals(d.getBytesWritten(), 3);
    
    Assert.assertNotEquals(d.deflate(b), -1);
  ...
  /*
   * Contains:
   *  -net.sf.zipme.Deflater_deflate2.Deflater_deflate2(Deflater, byte[], int, int)
